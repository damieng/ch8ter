...
import { type FontInstance, getPixel, setPixel, glyphAdvance, setGlyphAdvance } from '../store'
...
export function GlyphEditor({ font }: { font: FontInstance }) {
  ...
  const draggingGuide = useRef(false)
